...
%output: C 3x3xN or 2x2xN
    ...
    if(rA == 3 && cA == 3)
      C = MatMult3D_3x3(A,B,rA,cA,dA);  
    end
    
    if(rA == 2 && cA == 2)
      C = MatMult3D_2x2(A,B,rA,cA,dA);  
    end
    
    if(rA ~= cA)
        error('I can do square 2x2 adn 3x3 matrices only!')
    end
end

function C = MatMult3D_2x2(A,B,rA,cA,dA)
%A = B = 2x2xdA
...
function C = MatMult3D_3x3(A,B,rA,cA,dA)
%A = B = 3x3xdA

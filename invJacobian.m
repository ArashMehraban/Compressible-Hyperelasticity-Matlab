function [detsInvJe, inverseElemVtxJacobian] = invJacobian(elem_vtx_coords, D_hat, Q, dim)
%ELEMJACOBIAN computes the inverse of element Jacobian on vertex coordinates 
